...
export function Footer() {
  return (
    <footer className="bg-gray-100 dark:bg-inherit mt-12">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold mb-2">Moda-Co</h3>
            <p className="w-60 text-gray-600 dark:text-inherit">Sua loja completa para roupas modernas e cheias de estilo.</p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <ul className="text-gray-600 dark:text-inherit">
          ...
          <div className="w-full md:w-1/4">
            ...
            <p className="text-gray-600 dark:text-inherit mb-2">Assine nosso newsletter para receber novidades</p>
            <input type="email" placeholder="Email" className="w-full px-3 py-2 text-gray-700 dark:text-inherit border rounded-md focus:outline-none focus:border-blue-500 mb-3" />
            <Button size="sm" className="text-sm px-8 py-4">Enviar</Button>
          </div>
        </div>
        <div className="mt-8 text-center text-gray-600 dark:text-inherit">
